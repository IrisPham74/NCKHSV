...
class C2R(nn.Module):
    ...
    def forward(self, a, p, n1,  inp, weight): #n2, n3, n4, n5, n6,
        ...
        n1_weight, inp_weight = weight # n2_weight, n3_weight, n4_weight, n5_weight, n6_weight
        # print(weight) # 
        loss = 0
        for i in range(len(a_vgg)):
            ...
            if not self.ab:
                ...
                contrastive = d_ap / (
                        d_an1 * n1_weight + d_inp * inp_weight + 1e-7)
            else:
                contrastive = d_ap
